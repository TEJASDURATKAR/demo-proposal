    ...
    <>
      ...
      <section className="hero-section">
        <Container className="text-center">
          ...
          <p className="fade-in">I have something very special to ask you…</p>
        </Container>
      </section>
      ...
      <section className="letter-section">
        <Container>
          ...
          <Card className="letter-card">
            <Card.Body>
              <p>
                From the moment you entered my life, everything changed. You
                became my smile, my comfort, my home.
              </p>
              <p>
                I don’t promise perfection, but I promise honesty, loyalty, and
                a lifetime of love ❤️
              </p>
              <p>
        ...
        <Container className="text-center">
          {!accepted ? (
            ...
            <div className="celebration">
              <h1>She Said YES 😍💍</h1>
              <p>
                You just made me the luckiest person alive ❤️ I promise to love
                you forever.
              </p>
